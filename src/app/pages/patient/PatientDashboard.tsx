import avatarFemale from 'figma:asset/df8bf5999c1401542d3a02a783a7254d76a0a4dd.png';
import avatarMale from 'figma:asset/411c3b8f4e17ed8d3913383365e850ae5990c8f9.png';
import doctorMale from 'figma:asset/a8ded2880dfb49b5adb0c3286b9610f2558e0c92.png';
import doctorFemale from 'figma:asset/27b8b0cee838fb648384546cb5d7790a99097f4c.png';
...
export function PatientDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-emerald-700 to-teal-600 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 pr-36">
          ...
          <p className="text-emerald-100 text-sm mt-1">HN: 0012345 • วันจันทร์ที่ 2 มีนาคม 2569</p>

          <div className="mt-4 flex flex-wrap gap-3">
            <button
              onClick={() => navigate("/patient/appointment")}
              className="flex items-center gap-2 bg-white text-emerald-700 px-4 py-2 rounded-xl text-sm font-semibold hover:bg-emerald-50 transition-colors shadow-sm"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
            <h3 className="text-gray-900">นัดหมายที่กำลังจะถึง</h3>
            <button
              onClick={() => navigate("/patient/appointment")}
              ...
              <div key={appt.id} className="px-5 py-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 text-xs">{appt.specialty}</p>
                ...
                {appt.status === "confirmed" && (
                  <button
                    onClick={() => navigate("/patient/waiting-room")}
                    className="mt-3 w-full py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-sm font-medium transition-colors"
                  >
                    เข้าห้องรอพบแพทย์
                  </button>
                )}
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
            <h3 className="text-gray-900">การแจ้งเตือน</h3>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h4 className="text-gray-900">คำแนะนำสุขภาพจากแพทย์</h4>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <span className="text-xs text-emerald-700 font-medium">นัดติดตามผล: 10 มี.ค. 2569</span>
            </div>
          </div>
        </div>
      </div>
