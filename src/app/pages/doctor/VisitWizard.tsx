    ...
    switch (currentStep) {
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">CID: {patient.cid}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                <h4 className="text-gray-900 mb-4">ข้อมูลทั่วไป</h4>
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                <h4 className="text-gray-900 mb-4">ประวัติแพ้ยา / ข้อควรระวัง</h4>
                ...
                <div className="mt-4 pt-4 border-t border-gray-50">
                  <p className="text-xs text-gray-500">แหล่งข้อมูล: EHP · อัปเดตล่าสุด: 2 มี.ค. 69</p>
                </div>
              </div>
            </div>
      ...
      case 2:
        return (
          <div className="space-y-6">
            ...
            {/* Vitals */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-4">ข้อมูล Vital Signs</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={v.key}>
                    <label className="text-xs text-gray-500 block mb-1">{v.label}</label>
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">{v.unit}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Chief Complaint */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-4">อาการสำคัญ (Chief Complaint)</h4>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4">
                {["ปวดหัว/ไมเกรน", "ปวดกล้ามเนื้อ", "อ่อนเพลีย", "นอนไม่หลับ", "ระบบย่อยอาหาร", "ปัญหาผิวหนัง", "ปวดข้อ", "ภูมิแพ้", "อื่นๆ"].map((symptom) => (
                  <button
                    key={symptom}
                    className="py-2 px-3 text-xs border border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-400 hover:text-blue-700 transition-all text-left"
                  >
                    {symptom}
                  </button>
                ))}
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm resize-none"
              />
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-gray-900">ประเมินความเหมาะสม Telemedicine</h4>
                  <p className="text-sm text-gray-500 mt-0.5">ผู้ป่วยรายนี้เหมาะสมสำหรับการรักษาผ่าน Video หรือไม่?</p>
                </div>
                <div className="flex gap-2">
                  <button
                    onClick={() => setUnsuitable(false)}
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${!unsuitable ? "bg-emerald-600 text-white" : "border border-gray-200 text-gray-600 hover:bg-emerald-50"}`}
                  >
                    เหมาะสม ✓
                  </button>
                  <button
                    onClick={() => setUnsuitable(true)}
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${unsuitable ? "bg-red-600 text-white" : "border border-gray-200 text-gray-600 hover:bg-red-50"}`}
                  >
                    ไม่เหมาะสม ✗
                  </button>
                </div>
          ...
          <div className="space-y-5">
            {!callActive ? (
              <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm text-center">
                ...
                <h3 className="text-gray-900">เริ่มการปรึกษาผ่านวิดีโอ</h3>
                ...
                <div className="flex justify-center gap-3 mb-6">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm ${micOn ? "bg-gray-100 text-gray-700" : "bg-red-100 text-red-700"} hover:opacity-80 transition-all`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm ${camOn ? "bg-gray-100 text-gray-700" : "bg-red-100 text-red-700"} hover:opacity-80 transition-all`}
                  >
              ...
              <div className="bg-slate-900 rounded-2xl overflow-hidden" style={{ height: "400px" }}>
                <div className="relative h-full flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 bg-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3">
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                { key: "p", label: "P – Plan", placeholder: "แผนการรักษา เช่น สั่งยาขมิ้นชัน 500mg หลังอาหาร 2 มื้อ...", color: "border-emerald-200 focus:ring-emerald-400" },
              ].map((field) => (
                <div key={field.key} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-xl border bg-gray-50 focus:outline-none focus:ring-2 text-sm resize-none ${field.color}`}
                  />
                </div>
              ))}
            </div>
            ...
            {/* ICD-10 */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-3">รหัสโรค ICD-10-TM</h4>
              <div className="flex gap-3">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm font-mono"
                  />
                </div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {["G43.9 - Migraine", "J30.1 - Allergic rhinitis", "M54.5 - Low back pain", "R53.83 - Fatigue"].map((code) => (
                  <button
                    ...
                    className="text-xs bg-gray-100 text-gray-600 px-3 py-1.5 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition-colors"
                  >
                    {code}
                  </button>
                ))}
      ...
      case 5:
        return (
          <div className="space-y-5">
            {/* Medicines */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-4">รายการยาสมุนไพร</h4>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-400 text-sm"
                />
                <button
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {drugSuggestions.filter((d) => !medicines.includes(d)).map((d) => (
                  <button
                    ...
                    className="text-xs bg-gray-100 text-gray-600 px-2.5 py-1.5 rounded-lg hover:bg-amber-100 hover:text-amber-700 transition-colors"
                  >
                    + {d}
                  </button>
                ))}
            ...
            {/* Procedures */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-3">หัตถการ (Procedures)</h4>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {["นวดแผนไทย", "ประคบสมุนไพร", "อบไอน้ำสมุนไพร", "รมยา", "กดจุด", "ไม่มี"].map((p) => (
                  <button
                    key={p}
                    className="py-2 px-3 text-xs border border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-400 hover:text-blue-700 transition-all"
                  >
                    {p}
                  </button>
                ))}
            ...
            {/* Instructions */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-3">คำแนะนำผู้ป่วย</h4>
              <textarea
                rows={4}
                value={instructions}
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {["ดื่มน้ำมากๆ", "พักผ่อนให้เพียงพอ", "งดของมัน/หวาน", "ออกกำลังกายเบาๆ"].map((t) => (
                  <button
                    ...
                    className="text-xs bg-gray-100 text-gray-600 px-2.5 py-1.5 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition-colors"
                  >
                    + {t}
                  </button>
                ))}
      ...
      case 6:
        return (
          <div className="space-y-5">
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <h4 className="text-gray-900 mb-4">สรุปค่าบริการ</h4>
              <div className="space-y-3">
                ...
                <div className="border-t border-gray-100 pt-3 flex justify-between">
                  ...
                  <span className="font-semibold text-emerald-700 text-lg">฿900.00</span>
                </div>
              </div>
            </div>
            ...
            {paymentStatus === "pending" && (
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-4">
                <h4 className="text-gray-900">ช่องทางชำระเงิน</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {["PromptPay / QR Code", "บัตรเครดิต/เดบิต", "Mobile Banking", "เงินสด (Onsite)"].map((m) => (
                    <button
                      key={m}
                      className="p-3 border-2 border-gray-200 rounded-xl text-sm text-gray-600 hover:border-emerald-400 hover:bg-emerald-50 hover:text-emerald-700 transition-all text-center"
                    >
                      {m}
                    </button>
                  ))}
            ...
            {paymentStatus === "paid" && (
              <div className="bg-emerald-50 border border-emerald-300 rounded-2xl p-6 text-center">
                ...
                <h3 className="text-emerald-800">ชำระเงินสำเร็จ</h3>
                <p className="text-emerald-600 text-sm mt-1">฿900.00 · REF: PAY-20260302-0034</p>
                <p className="text-emerald-500 text-xs mt-0.5">2 มี.ค. 2569 เวลา 10:45:23 น.</p>
              </div>
            )}
          </div>
        );
      ...
      case 7:
        return (
          <div className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                <h4 className="text-gray-900 mb-4">เอกสารที่จะสร้าง</h4>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={doc.label} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                      <PaperIcon className={`w-4 h-4 flex-shrink-0 ${doc.ready ? "text-blue-600" : "text-gray-300"}`} />
                      <span className={`flex-1 text-sm ${doc.ready ? "text-gray-800" : "text-gray-400"}`}>{doc.label}</span>
                      {doc.ready && (
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                <h4 className="text-gray-900 mb-4">ลงนามดิจิทัล (MOPH CA)</h4>
                {!signed ? (
                  <div className="space-y-4">
                    <div className="bg-gray-50 rounded-xl p-4 text-center">
                      <FileSignature className="w-10 h-10 text-gray-400 mx-auto mb-2" />
                      <p className="text-sm text-gray-600">ลงนามเอกสารด้วย MOPH CA Digital Signature</p>
                    </div>
                    <div>
                      <label className="text-xs text-gray-500 block mb-1">PIN ลงนาม</label>
                      <input
                        type="password"
                        placeholder="กรอก PIN 6 หลัก"
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
                        maxLength={6}
                      />
                    </div>
                    <button
                      onClick={() => setSigned(true)}
                      className="w-full py-2.5 bg-violet-600 text-white rounded-xl font-medium hover:bg-violet-700 transition-colors text-sm"
                    >
                  ...
                  <div className="space-y-4">
                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-center">
                      ...
                      <p className="text-sm font-semibold text-emerald-800">ลงนามสำเร็จ</p>
                      <p className="text-xs text-emerald-600 mt-1">Timestamp: 2026-03-02T10:47:23Z</p>
                      <p className="text-xs text-emerald-600">Hash: SHA256: a3f8b2...</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4 text-center">
                      <QrCode className="w-16 h-16 text-gray-700 mx-auto" />
                      <p className="text-xs text-gray-500 mt-2">QR Code สำหรับตรวจสอบความถูกต้อง</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-emerald-800">Visit สำเร็จ</h3>
                  <p className="text-sm text-emerald-600">Encounter ID: ENC-20260302-0034</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-3">
              <h4 className="text-gray-900">แจ้งผู้ป่วย</h4>
              <div className="space-y-2">
                {[
                  ...
                  <label key={n.label} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
            ...
            {/* Follow-up */}
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-3">
              <h4 className="text-gray-900">นัดติดตามผล (Follow-up)</h4>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-400 text-sm"
                  />
                </div>
                <div>
                  <label className="text-xs text-gray-500 block mb-1">เหตุผล</label>
                  <input
                    type="text"
              ...
              <button className="w-full py-2.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-xl font-medium hover:bg-emerald-100 transition-colors text-sm">
                สร้างนัดติดตาม
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-emerald-700 text-white rounded-2xl font-semibold hover:bg-emerald-800 transition-colors text-base flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-gray-700 text-sm">Visit: {patient.name}</span>
            ...
            return (
              <div key={step.id} className="flex items-center">
                ...
                >
                  ...
                  <span className={`text-xs whitespace-nowrap ${isActive ? "text-blue-600 font-semibold" : isDone ? "text-emerald-600" : "text-gray-400"}`}>
                    {step.short}
                  </span>
                </button>
                {idx < STEPS.length - 1 && (
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-0.5">{currentStep} จาก 8 ขั้นตอน</p>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 flex gap-3 p-4 bg-white/95 backdrop-blur-sm border-t border-gray-100 sm:static sm:bg-transparent sm:border-0 sm:p-0 sm:sticky sm:bottom-4 sm:z-10 sm:backdrop-blur-none">
        {currentStep > 1 ? (
          <button
            onClick={() => setCurrentStep((s) => s - 1)}
            className="flex items-center justify-center gap-2 flex-1 sm:flex-none sm:px-5 py-3 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors shadow-sm"
          >
            <ChevronLeft className="w-4 h-4" />
            ย้อนกลับ
          </button>
        ...
        {currentStep < STEPS.length ? (
          <button
            ...
            className={`flex items-center justify-center gap-2 flex-1 sm:flex-none sm:px-5 py-3 rounded-xl text-sm font-medium transition-all shadow-sm
              ${canNext() ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}
          >
            ถัดไป
          ...
          <button
            onClick={() => canNext() && navigate("/doctor")}
            disabled={!canNext()}
            className={`flex items-center justify-center gap-2 flex-1 sm:flex-none sm:px-5 py-3 rounded-xl text-sm font-medium transition-all shadow-sm
              ${canNext() ? "bg-emerald-600 text-white hover:bg-emerald-700" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}
          >
            บันทึกและเสร็จสิ้น
            <ChevronRight className="w-4 h-4" />
          </button>
