...
export function AdminDashboard() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-gray-900">แดชบอร์ด</h2>
        <p className="text-gray-500 text-sm mt-1">ภาพรวมระบบ Telemedicine วันจันทร์ที่ 2 มีนาคม 2569</p>
      </div>
        ...
        {[
          ...
          return (
            <div key={stat.label} className={`bg-white rounded-2xl border ${stat.border} p-5 shadow-sm`}>
              ...
              <p className="text-gray-400 text-xs">{stat.changeLabel}</p>
            </div>
          );
        })}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-gray-900">จำนวน Visit รายวัน (สัปดาห์นี้)</h4>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <h4 className="text-gray-900 mb-4">สัดส่วนการวินิจฉัย</h4>
      ...
      {/* Revenue Chart */}
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <h4 className="text-gray-900 mb-4">รายได้รายสัปดาห์ (บาท)</h4>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
          <h4 className="text-gray-900">กิจกรรมล่าสุด (Audit)</h4>
          <button className="text-violet-600 text-sm hover:underline">ดูทั้งหมด →</button>
        </div>
            ...
            return (
              <div key={act.id} className="px-5 py-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">โดย {act.user}</p>
                </div>
